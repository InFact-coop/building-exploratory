  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <Feature coordinates={[building.longitude, building.latitude]} />
        </Layer>
        <Layer
          type="symbol"
          id="marker-onMouseEnter"
          layout={{ "icon-image": "circle-stroked-15", "icon-size": 2 }}
        >
          {/*
          <Feature
            coordinates={[
              this.state.hoverBuilding.longitude,
              this.state.hoverBuilding.latitude
            ]}
          />
      */}
        </Layer>
